...
I am extremely excited and proud with the completion and release of TrashMapr, though it is far from complete as there are always a number of ways to refine an app! TrashMapr is my first iOS release and was a complete learning process, throughout the process I honed my skills in multiple frameworks and libraries, such as UIKit and CoreLocation. I learned to efficiently utilize independent Cocoapod libraries such as Lyft's Kronos. I also refined my skills in Google's back-end service, Firebase, where I was able to learn and implement phone authentication, geocoding, and real-time updates.
